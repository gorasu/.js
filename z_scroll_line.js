     ...
     *      @param options = {
     *
     *      'scrollParent':$(document) // элемент который скролится по умолчанию это все окно браузера, 
     * но в зависимости от требований можно передать и конкретный DOM элемент на котором расположен скролл
     *      'userLinePrepare':
     *                    //фукция которая высчитывает положение пользовательской линии пересечения(userline) фукнция
     * должна возвращать числовое значение
     *                    //  @param crossLines =  {'Top':num,'Bottom':num,'Middle':num} // Линии пересечения по 
     * умолчанию
